...
import com.trade.bluehole.trad.record.views.ThemeGroupLayout;
import com.trade.bluehole.trad.record.views.ThemeView;
...
public class MediaPreviewActivity extends BaseActivity implements
    ...
    private void prepareViews() {
        setContentView(R.layout.rd_activity_media_preview);
