package com.trade.bluehole.trad.util.update;
...
import com.trade.bluehole.trad.FullscreenActivity;
...
public class UpdateManager {
    ...
    private final static int NO_UPDATA_CLIENT=0;
    private final static int UPDATA_CLIENT=1;
 ...
 */
    public class CheckVersionTask extends Thread{
        ...
        public void run() {
            try {
                ...
                //从资源文件获取服务器 地址
                String path = DataUrlContents.UPDATE_SERVER_HOST + "version.xml";
                //包装成url的对象
    ...
    protected void showUpdataDialog(boolean boo) {
        if (boo) {
            // 显示提示对话框
            showNoticeDialog();
        } else {
